...
//               uint8_t 
//               >
//     ipmiSensorcmd_test(uint8_t Num)
// {
//     if(Num == 1) return ipmi::responseSuccess(0x01, 0x02, 0x03, 0x04, 0x05);
//     else if(Num == 0) return ipmi::responseSuccess(0x00, 0x00, 0x00, 0x00, 0x00);
//     else return ipmi::responseSensorInvalid();
// }
